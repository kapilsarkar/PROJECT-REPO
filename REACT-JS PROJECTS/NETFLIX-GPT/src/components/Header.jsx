...
const Header = () => {
  ...
  return (
    <div className="absolute w-full px-5 sm:px-8 py-3 bg-gradient-to-b from-black/80 via-black/60 to-transparent z-10 flex justify-between items-center backdrop-blur-md">
      {/* Logo */}
      <img
